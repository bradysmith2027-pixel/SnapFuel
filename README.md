...
📓 **[View the Model Training Notebook](notebooks/snapfuel_model_training.ipynb)** — Full pipeline including data preprocessing, EfficientNetB0 fine-tuning, and evaluation
